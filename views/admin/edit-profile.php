    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body p-4">
                ...
                <form action="/mini_OnShop/admin/handleEditProfile" method="POST">
                    <div class="mb-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="/mini_OnShop/admin/profile" class="btn btn-outline-secondary"><i class="bi bi-x-lg"></i> Cancel</a>
                    </div>
                </form>
            </div>
        </div>
